...
def admin_metrics_adherence():
    ...
    try:
        ...
        # Adiciona entrada para usuários sem consentimento (ou revogado)
        ...
        # Ordena a lista pela versão mais recente primeiro (ID maior)
        def sort_key(item):
